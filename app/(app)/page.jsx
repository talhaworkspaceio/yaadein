...
export default function HomePage() {
  ...
  const heroVideoSrc = homeCms?.hero?.backgroundVideo?.url || (homeCms?.hero?.backgroundVideoUrl && homeCms.hero.backgroundVideoUrl.trim() !== "" ? homeCms.hero.backgroundVideoUrl : "/videos/yaadein.mp4");
